...
const SleepingReview = () => {
  ...
  useEffect(() => {
    // 1️⃣ 가게 정보 가져오기
    fetch("http://localhost:8000/api/sleeping")
      .then(res => res.json())
      .then(data => {
    ...
    // 2️⃣ 리뷰 정보 가져오기
    fetch(`http://localhost:8000/api/sleeping/${storeId}/review`)
    .then(res => res.json())
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="text-gray-500 mb-4">⭐ {shop.rating} / 혼숙 점수 {shop.hon0_index}</p>
